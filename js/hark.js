...
$("body").keypress(function(event){
	if (event.which==108){
		...
		console.log("Next!");
		controller.init();
		$("body").animate({opacity:0,backgroundColor:model.bgColor},400,function(){
			view.init();
